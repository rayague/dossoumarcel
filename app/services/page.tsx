            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="container w-full h-auto flex-col flex gap-3 p-5 bg-gray-800 rounded-lg">
                ...
                <p className="text-white text-xl font-light">
                  ...
                  l&apos;énergie renouvelable, apportant des solutions pratiques
              ...
              <div className="container w-full h-auto flex-col flex gap-3 p-5 bg-gray-800 rounded-lg">
                ...
                <p className="text-white text-xl font-light">
                  ...
                  l&apos;économie touristique, l&apos;inégalité des revenus, et
                  le développement économique, contribuant ainsi à la recherche
                  et à l&apos;enrichissement des connaissances dans le domaine.
                </p>
              </div>
              <div className="container w-full h-auto flex-col flex gap-3 p-5 bg-gray-800 rounded-lg">
                <FontAwesomeIcon
